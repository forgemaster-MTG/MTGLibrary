            ...
            <div className="max-w-4xl mx-auto px-6 space-y-16">
                ...
                <section className="space-y-8 animate-fade-in-up">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Scryfall */}
                        <a href="https://scryfall.com" target="_blank" rel="noopener noreferrer" className="bg-gray-800/50 p-6 rounded-2xl border border-gray-700 hover:border-indigo-500 hover:bg-gray-800 transition-all group">
                            <div className="text-indigo-400 mb-4 group-hover:scale-110 transition-transform origin-left">
                    ...
                    <div className="bg-gradient-to-br from-indigo-900/20 to-purple-900/20 p-8 rounded-3xl border border-white/5 relative overflow-hidden">
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            ...
                            <a
                                ...
                                className="px-8 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-indigo-500/25 flex items-center gap-3 transform hover:-translate-y-1"
                            >
