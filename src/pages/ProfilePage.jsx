...
const ProfilePage = () => {
    ...
    return (
        <div className="relative min-h-screen">
            ...
            {/* Fallback dark overlay if no avatar */}
            {!profile?.avatar && <div className="fixed inset-0 z-0 bg-slate-950 pointer-events-none" />}

            <div className="relative z-10 pb-20">
                {/* 1. Transparent Top Spacer (Lets the immersive background shine) */}
                <div className="relative h-64 md:h-72 w-full"></div>
                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
                        ...
                        <div className="space-y-8">
                            {/* Archetype Badge */}
                            <div className="bg-slate-900/60 backdrop-blur-md rounded-2xl p-6 border border-white/5 shadow-xl hover:border-white/10 transition-colors">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {decks.length > 0 ? decks.map(deck => (
                                        <div
                                            ...
                                            className="group cursor-pointer relative bg-slate-900/60 backdrop-blur-md border border-white/5 hover:border-primary-500/50 rounded-2xl p-6 transition-all hover:-translate-y-1 hover:shadow-2xl overflow-hidden"
                                        >
