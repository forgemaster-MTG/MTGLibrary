                ...
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end mb-12 gap-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 w-full xl:w-auto items-center">
                        ...
                        <button
                            ...
                            className={`p-2 h-10 w-10 flex items-center justify-center rounded-xl border transition-all ${isReorderUnlocked ? 'bg-indigo-600 text-white border-indigo-500 shadow-lg shadow-indigo-500/20' : 'bg-gray-900/50 text-gray-400 border-gray-700 hover:text-white hover:border-gray-500'}`}
                        ...
                        {availableTags.length > 0 && (
                            <div className="relative group">
                                <select
                                    className="appearance-none block w-full md:w-48 pl-3 pr-10 py-2 border border-gray-700 rounded-xl leading-5 bg-gray-900/50 text-gray-300 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 sm:text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none block w-full md:w-40 pl-3 pr-10 py-2 border border-gray-700 rounded-xl leading-5 bg-gray-900/50 text-gray-300 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 sm:text-sm transition-all font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={isReorderUnlocked}
                            >
                        ...
                        <Link
                            ...
                            className="group bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2 rounded-xl font-black uppercase tracking-widest text-xs transition-all shadow-lg shadow-indigo-500/20 flex items-center justify-center gap-2 border border-indigo-400/20 hover:border-indigo-400 whitespace-nowrap"
                        >
                    ...
                    <div className="flex flex-wrap gap-2 mb-8 animate-fade-in">
                        {filterTags.map(tag => (
                            <button
                                ...
                                className="bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-xs font-bold px-3 py-1 rounded-full flex items-center gap-2 hover:bg-indigo-500/30 transition-colors"
                            >
                                {tag}
                                <span className="text-indigo-400/50 hover:text-white">×</span>
                            </button>
                        ))}
                ...
                {myLoading ? (
                    ...
                    <div className="mb-12 animate-fade-in relative z-10">
                        <div className="flex justify-between items-end mb-6 border-b border-white/5 pb-4">
                            ...
                            {isReorderUnlocked && (
                                <div className="w-full md:w-auto bg-indigo-500/10 border border-indigo-500/30 rounded-xl px-4 py-2 flex items-center justify-center gap-3 animate-pulse">
                                    <svg className="w-5 h-5 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>
