                        ...
                        <div className="flex gap-4">
                            <div className="relative flex-1">
                                <input
                                    ...
                                    className="w-full bg-gray-950 border border-white/10 rounded-2xl py-4 pl-14 pr-4 text-lg text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all shadow-inner"
