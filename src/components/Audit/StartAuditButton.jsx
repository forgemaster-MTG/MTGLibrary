...
export default function StartAuditButton({ type, targetId, label = "Start Audit", className = "" }) {
    ...
    return (
        <>
            <button
                onClick={handleOpen}
                className={`flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-500 text-white font-medium rounded-lg transition-colors shadow-lg shadow-primary-500/20 disabled:opacity-50 ${className}`}
            >
