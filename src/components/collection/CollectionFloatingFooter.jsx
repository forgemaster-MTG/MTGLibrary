            ...
            <div className="max-w-4xl mx-auto bg-gray-900/90 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-3 flex items-center gap-3 pointer-events-auto">
                ...
                <div className="relative flex-1">
                    <input
                        ...
                        className="w-full bg-gray-950/50 border border-gray-700 text-white pl-9 pr-3 py-2 rounded-xl text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all placeholder-gray-500"
                    />
             ...
             <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-lg border border-indigo-400 pointer-events-auto">
