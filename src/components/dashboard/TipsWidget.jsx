...
const TipsWidget = () => {
    ...
    return (
        <div className="bg-gray-900/50 border border-white/5 rounded-3xl p-4 backdrop-blur-md relative overflow-hidden group min-h-[140px] flex flex-col">
            ...
            <h2 className="font-bold text-white mb-2 flex items-center gap-2 relative z-10 text-xs">
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-between">
                <p
                    className={`text-[11px] text-gray-300 leading-relaxed transition-opacity duration-300 ${isAnimating ? 'opacity-0' : 'opacity-100'}`}
                >
                ...
                <div className="flex items-center justify-between mt-3 border-t border-white/5 pt-2">
                    <span className="text-[9px] text-gray-600 font-mono uppercase">
                        {currentTipIndex + 1} / {dashboardTips.length}
                    </span>
