...
const LibraryItem = ({ id }) => {
    ...
    return (
        ...
        >
            <div className="w-6 h-6 bg-primary-500/20 rounded flex items-center justify-center text-xs text-primary-400 font-bold">
                +
            </div>
...
const WidgetLibrary = ({ layout }) => {
    ...
    return (
        <div className="mb-6 p-4 bg-gray-900/80 border border-primary-500/30 rounded-2xl backdrop-blur-md animate-slide-down">
